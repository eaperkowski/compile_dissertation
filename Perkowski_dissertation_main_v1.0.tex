...
%% Single space references, double space between references,
%% change indent
...
\addcontentsline{toc}{section}{B: Supplemental material for ``Soil nitrogen availability modifies leaf nitrogen economies in mature temeprate deciduous forests: a direct test of photosynthetic least-cost theory''}
\input{ch3_NxpH/ch3_NxpH_appendix.tex}
\addcontentsline{toc}{section}{C: Supplemental material for ``The relative cost of resource use for photosynthesis drives variance in leaf nitrogen content across a climate and soil resource availability gradient''}
\input{ch4_TXeco/ch4_TXeco_appendix.tex}
\addcontentsline{toc}{section}{D: Supplemental material for ``Optimal resource investment to photosynthetic capacity maximizes nutrient allocation to whole plant growth under elevated CO$_2$''}
