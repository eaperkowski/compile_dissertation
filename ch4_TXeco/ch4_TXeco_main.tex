...
\begin{landscape}
    \begin{figure}
    \centering
    \includegraphics[width=\columnwidth]{ch4_TXeco/figs/TXeco_fig2_beta.png}
...
\begin{landscape}
    ...
    \resizebox{\columnwidth}{!}{
        \begin{tabular}{p{3.75cm}p{0.5cm}p{1.75cm}p{1.5cm}p{1.5cm}p{1.75cm}p{1.5cm}p{1.5cm}p{1.75cm}p{1.5cm}p{1.5cm}}
            ...
            &  \multicolumn{1}{r}{$2.41*10^{0}$}     & \multicolumn{1}{r}{-}             & \multicolumn{1}{r}{-}
            &  \multicolumn{1}{r}{$7.72*10^{-2}$}   & \multicolumn{1}{r}{-}             & \multicolumn{1}{r}{-}
            &  \multicolumn{1}{r}{$6.91*10^{0}$}     & \multicolumn{1}{r}{-}             & \multicolumn{1}{r}{-} 
            \\

            $C_\mathrm{i}$:$C_\mathrm{a}$ & \multicolumn{1}{r}{1}
            & \multicolumn{1}{r}{$-2.32*10^{0}$}     & \multicolumn{1}{r}{6.841}         & \multicolumn{1}{r}{\textbf{0.009}}
            & \multicolumn{1}{r}{$7.91*10^{-1}$}    & \multicolumn{1}{r}{0.558}         & \multicolumn{1}{r}{0.455}
            & \multicolumn{1}{r}{$-3.13*10^{0}$}     & \multicolumn{1}{r}{15.913}        & \multicolumn{1}{r}{\textbf{<0.001}} 
            \\ % updated


            Soil N (N) & \multicolumn{1}{r}{1}
            & \multicolumn{1}{r}{$1.26*10^{-2}$}    & \multicolumn{1}{r}{7.072}         & \multicolumn{1}{r}{\textbf{0.011}}
            & \multicolumn{1}{r}{$1.21*10^{-2}$}    & \multicolumn{1}{r}{87.457}        & \multicolumn{1}{r}{\textbf{<0.001}}
            & \multicolumn{1}{r}{$-2.66*10^{-2}$}   & \multicolumn{1}{r}{41.791}        & \multicolumn{1}{r}{\textbf{<0.001}} 
            \\ % updated

            Soil moisture (SM$_{90}$) & \multicolumn{1}{r}{1}
            & \multicolumn{1}{r}{$5.60*10^{-1}$}      & \multicolumn{1}{r}{6.493}         & \multicolumn{1}{r}{\textbf{0.011}}
            & \multicolumn{1}{r}{$7.94*10^{-1}$}      & \multicolumn{1}{r}{10.889}        & \multicolumn{1}{r}{\textbf{<0.001}}
            & \multicolumn{1}{r}{$-2.54*10^{-1}$}     & \multicolumn{1}{r}{0.605}         & \multicolumn{1}{r}{0.437} 
            \\ % updated
            ...
            & \multicolumn{1}{r}{$5.45*10^{-2}$}     & \multicolumn{1}{r}{0.482}         & \multicolumn{1}{r}{0.488}
            & \multicolumn{1}{r}{$-2.18*10^{-2}$}     & \multicolumn{1}{r}{2.606}        & \multicolumn{1}{r}{0.106}
            & \multicolumn{1}{r}{$8.16*10^{-2}$}      & \multicolumn{1}{r}{0.791}        & \multicolumn{1}{r}{0.374} 
            \\ % updated
...
\begin{table}
    ...
    %\resizebox{\columnwidth}{!}{
        \begin{tabular}{p{0.5cm}p{3cm}p{1.5cm}p{1.5cm}}
            ...
            & \multicolumn{1}{l}{SM$_{90}$} & \multicolumn{1}{r}{-0.262} & \multicolumn{1}{r}{\textbf{<0.001}} \\
            & \multicolumn{1}{l}{\% clay} & \multicolumn{1}{r}{-0.292} & \multicolumn{1}{r}{\textbf{<0.001}} \\
            \hline
