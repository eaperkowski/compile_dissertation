...
\section{Discussion}
In this chapter, I quantified direct and indirect effects of soil resource availability, climate,$\beta$, and $\chi$ on $N_\mathrm{area}$ and components of $N_\mathrm{area}$ ($N_\mathrm{mass}$ and $M_\mathrm{area}$) in 520 individuals spanning across a soil resource availability and climate gradient in Texas, USA. We found consistent support for patterns expected from photosynthetic least-cost theory, a result driven by a strong direct negative effect of increasing $\chi$ on $N_\mathrm{area}$ (Fig. \ref{fig:figure4.4}a; Fig. \ref{fig:figure4.5}) and a positive relationship between $\chi$ and $\beta$ (Fig. \ref{fig:figure4.5}). In further support of patterns expected from theory, increasing soil nitrogen availability had a strong negative effect on $\beta$ (Fig. \ref{fig:figure4.2}a), resulting in an indirect stimulation in $N_\mathrm{area}$ (Fig. \ref{fig:figure4.5}) despite a marginal positive direct association between increasing soil nitrogen availability and $N_\mathrm{area}$ (p = 0.092; Table \ref{tab:table4.4}; Fig. \ref{fig:figure4.4}d). Increasing VPD also indirectly increased $N_\mathrm{area}$ through a direct negative effect of increasing VPD on $\chi$ (Fig. \ref{fig:figure4.3}a; Fig. \ref{fig:figure4.5}). Interestingly, we found no effect of soil moisture on $\beta$ (Fig. 1b; Fig. \ref{fig:figure4.5}), though a strong positive association between soil moisture and soil nitrogen availability resulted in an indirect positive effect of increasing soil moisture on $N_\mathrm{area}$ (Fig. \ref{fig:figure4.5}) despite an apparent null direct effect of soil moisture on $N_\mathrm{area}$ (Fig. \ref{fig:figure4.4}g). Overall, results provide strong and consistent support for patterns expected from photosynthetic least-cost theory, showing that $\chi$ is a dynamic driver of variance in $N_\mathrm{area}$ and is capable of unifying expected responses of $N_\mathrm{area}$ to shifts in soil resource availability and climate.