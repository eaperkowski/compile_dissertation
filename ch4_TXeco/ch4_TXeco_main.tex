...
\begin{landscape}
    ...
    \resizebox{\columnwidth}{!}{
        \begin{tabular}{p{3.75cm}p{0.5cm}p{1.75cm}p{1.5cm}p{1.5cm}p{1.75cm}p{1.5cm}p{1.5cm}p{1.75cm}p{1.5cm}p{1.5cm}}
            ...
            &  \multicolumn{1}{r}{7.72E$-$02}   & \multicolumn{1}{r}{-}             & \multicolumn{1}{r}{-}
            &  \multicolumn{1}{r}{6.91E+00}     & \multicolumn{1}{r}{-}             & \multicolumn{1}{r}{-} 
            \\

            $C_\mathrm{i}$:$C_\mathrm{a}$ & \multicolumn{1}{r}{1}
            & \multicolumn{1}{r}{-2.32E+00}     & \multicolumn{1}{r}{6.841}         & \multicolumn{1}{r}{\textbf{0.009}}
            & \multicolumn{1}{r}{7.91E$-$01}    & \multicolumn{1}{r}{0.558}         & \multicolumn{1}{r}{0.455}
