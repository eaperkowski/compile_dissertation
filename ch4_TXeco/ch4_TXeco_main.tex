...
\begin{landscape}
    \begin{figure}
        \centering
        \includegraphics[scale = 0.4]{ch4_TXeco/figs/TXeco_fig1_site_map.png}
...
\begin{landscape}
    \begin{figure}
    \centering
    \includegraphics[width=\textwidth]{ch4_TXeco/figs/TXeco_fig2_beta.png}
...
\begin{table}
    ...
    %\resizebox{\columnwidth}{!}{
        \begin{tabular}{p{6cm}p{0.5cm}p{2cm}p{1.5cm}p{1.5cm}}
            ...
            & \multicolumn{1}{r}{1}
            & \multicolumn{1}{r}{-1.71E$-$01} %% DWS: Not correct notation
            ...
            SM$_{90}$*N
            & \multicolumn{1}{r}{1}
            & \multicolumn{1}{r}{7.29E$-$03} %% DWS: fix
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{ch4_TXeco/figs/TXeco_fig3_chi.png}
...
\newpage
    \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{ch4_TXeco/figs/TXeco_fig4_narea.png}
...
\newpage
    \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{ch4_TXeco/figs/TXeco_fig5_SEM.png}
