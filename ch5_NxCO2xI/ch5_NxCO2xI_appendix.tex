...
\begin{center}
    \begin{singlespace}
        \textbf{Supplemental material for ``Optimal resource investment to photosynthetic capacity maximizes nutrient allocation to whole plant growth under elevated CO$_2$''}
    \end{singlespace}
\end{center}
